...
void main() {
  ...
  group('searchFruits', () {
    test('should return NetworkSuccess with matching fruits when matching documents exist', () async {
      // Arrange
      await fakeFirestore
    ...
    test('should return NetworkSuccess with empty list when no products match query', () async {
      // Arrange
      await fakeFirestore
          .collection(BackendEndpoints.productsCollection)
          .add(tFruitJson1);
    ...
    test('should return NetworkSuccess with empty list when products collection is empty', () async {
    ...
    test(
      ...
      () async {
        // Arrange
        await fakeFirestore.collection(BackendEndpoints.productsCollection).add(
          {'name': 'Apple Red'},
        );
        await fakeFirestore.collection(BackendEndpoints.productsCollection).add(
          {'name': 'Apple Green'},
  ...
  group('Model and Entity Mappings', () {
    ...
    test('ReviewModel fromJson should handle uId alias fallback and missing fields', () {
      // Arrange
