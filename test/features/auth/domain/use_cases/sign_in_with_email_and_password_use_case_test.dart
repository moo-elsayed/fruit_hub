...
void main() {
  ...
  const tUserEntity = UserEntity(uid: '123', name: 'user');
  ...
  setUp(() {
    ...
    sut = SignInWithEmailAndPasswordUseCase(
      mockAuthRepo,
      mockSaveUserSessionUseCase,
    );
    when(
  ...
  group('signInWithEmailAndPassword UseCase', () {
    test(
      ...
      () async {
        ...
        // Act
        final result = await sut.call(password: tPassword, email: tEmail);
