...
void main() {
  ...
  group('updateProfile', () {
    test(
      'should map UpdateProfileInputEntity to UpdateProfileInputModel, call remoteDataSource.updateProfile, and return NetworkSuccess with mapped UserEntity',
      () async {
        // Arrange
        when(
    ...
    test(
      'should return default UserEntity when remoteDataSource returns NetworkSuccess with null data',
      () async {
        // Arrange
        when(
          () => mockRemoteDataSource.updateProfile(any()),
    ...
    test(
      'should return NetworkFailure with same failure when remoteDataSource fails during updateProfile',
      () async {
        // Arrange
        when(
          () => mockRemoteDataSource.updateProfile(any()),
  ...
  group('changePassword', () {
    test(
      'should call remoteDataSource.changePassword with correct arguments and return NetworkSuccess',
      () async {
        // Arrange
        when(
    ...
    test(
      'should return NetworkFailure when remoteDataSource fails during changePassword',
      () async {
        // Arrange
        when(
          () => mockRemoteDataSource.changePassword(
