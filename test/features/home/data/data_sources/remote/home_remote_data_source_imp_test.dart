...
class MockQueryParameters extends Mock implements QueryParameters {}

void main() {
  late HomeRemoteDataSourceImp sut;
  late MockDatabaseService mockDatabaseService;

  const tQueryParameters = QueryParameters(
    descending: true,
    limit: 10,
    orderBy: "sellingCount",
  );

  const tPath = BackendEndpoints.getBestSellerProducts;
  ...
  setUpAll(() {
    ...
    registerFallbackValue(MockQueryParameters());
  });

  setUp(() {
    mockDatabaseService = MockDatabaseService();
    sut = HomeRemoteDataSourceImp(mockDatabaseService);
  });
